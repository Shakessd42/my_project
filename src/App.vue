...
export default {
    ...
    data() {
        ...
        return {
            motorcycles: [
                { id: 1, name: 'Мотоцикл GR8 f300a (4t)',       price: 330182, oldPrice: 399990, image: '/my_project/photos/gr8 f300a.png',         monthly: 30000, credit: 12000, cashback: 36000 },
                { id: 2, name: 'Мотоцикл GR8 t300l',             price: 431990, oldPrice: 479990, image: '/my_project/photos/gr8 t300l.png',         monthly: 36000, credit: 14400, cashback: 43200 },
                { id: 3, name: 'Мотоцикл PROGASI HARDCORE',      price: 419990, oldPrice: null,   image: '/my_project/photos/progasi hardcore.jpg',  monthly: 35000, credit: 14000, cashback: 42000 },
                { id: 4, name: 'Мотоцикл Progasi RACE 300 AIR',  price: 289990, oldPrice: null,   image: '/my_project/photos/progasi 300 air.jpeg', monthly: 24170, credit: 9670,  cashback: 29000 },
                { id: 5, name: 'Мотоцикл KAYO K1 250mx',         price: 161990, oldPrice: 179990, image: '/my_project/photos/kayo k1.jpg',           monthly: 14000, credit: 5000,  cashback: 16000 },
                { id: 6, name: 'Мотоцикл BSE Z1',                price: 169990, oldPrice: null,   image: '/my_project/photos/bse z1.png',            monthly: 14000, credit: 5000,  cashback: 17000 },
                { id: 7, name: 'Мотоцикл GR-X YX160',            price: 139490, oldPrice: 139490, image: '/my_project/photos/grx.png',                 monthly: 11000, credit: 4000,  cashback: 14000 }
            ],
...
<template>
    ...
    <section id="home" class="hero-section">
        <div class="hero-content">
            <img :src="'/my_project/photos/logo_dark.png'" alt="Z-MOTORS" class="hero-logo">
    ...
    <section class="info-section">
        <div class="info-container">
            <img :src="'/my_project/photos/info_now.png'" alt="Акции" class="info-banner">
        </div>
    </section>
            ...
            <div class="row g-4 justify-content-center mt-3">
                <div class="col-12 col-md-4">
                    <div class="partner-card p-4 text-center rounded">
                        <img :src="'/my_project/logos/Partner_6.png'" alt="Avito" class="partner-logo">
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="partner-card p-4 text-center rounded">
                        <img :src="'/my_project/logos/yandex_logo.png'" alt="Яндекс" class="partner-logo">
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="partner-card p-4 text-center rounded">
                        <img :src="'/my_project/logos/Partner_9.png'" alt="Сбербанк" class="partner-logo">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="feature-card feature-orange">
                <div class="feature-icon">
                    <img :src="'/my_project/photos/favourite.png'" alt="Лучшие цены" width="150" height="150">
                </div>
            ...
            <div class="feature-card feature-blue">
                <div class="feature-icon">
                    <img :src="'/my_project/photos/videochat.png'" alt="Видеоконсультация" width="150" height="150">
                </div>
                <div class="feature-content">
            ...
            <div class="feature-card feature-dark">
                <div class="feature-icon">
                    <img :src="'/my_project/photos/S600xU_2x (1).png'" alt="Развитие" width="150" height="150">
                </div>
                <div class="feature-content">
        ...
        <div class="container">
            <div class="promo-grid">
                <div class="promo-card promo-yellow">
                    ...
                    <img :src="'/my_project/photos/helmet.png'" alt="шлем" class="promo-image">
                </div>
                <div class="promo-card promo-white">
                    <div class="promo-content">
                        ...
                        <img :src="'/my_project/photos/сотсети.png'" alt="соцсети" class="social-icons">
                    </div>
                    <img :src="'/my_project/photos/enduro.jpg'" alt="эндуро" class="promo-bike">
                </div>
            </div>
        </div>
    </section>
